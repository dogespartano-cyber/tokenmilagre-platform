...
<h1 className="title-newtab text-4xl sm:text-5xl md:text-8xl tracking-tighter leading-none bg-clip-text text-transparent bg-gradient-to-b from-[var(--text-primary)] to-[var(--text-secondary)]">
      ...
      <p className="text-base md:text-xl lg:text-2xl text-[var(--text-secondary)] font-light max-w-2xl mx-auto leading-relaxed px-2">
       Construindo um refúgio de <span className=" font-medium">educação</span> e <span className=" font-medium">prosperidade</span> em um mercado caótico.
      </p>
    ...
    <section id="manifesto" className="py-16 md:py-32 px-4 md:px-6 scroll-mt-32">
     <div className="max-w-3xl mx-auto space-y-8 md:space-y-12">
      <span className=" font-mono text-sm tracking-widest uppercase mb-4 block">01 — Nossa Missão</span>

<h2 className="title-newtab text-2xl sm:text-3xl md:text-5xl leading-tight">
       Não somos apenas um token.<br />
       Somos um <span className="italic font-serif dark:">movimento educacional</span>.
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-6 h-auto md:h-[600px]">
       ...
       <div className="md:col-span-1 md:row-span-1">
        <ZenithCard variant="slate" className="h-full p-10 flex flex-col justify-center transition-all hover:-translate-y-2 hover:shadow-xl">
         <span className=" font-mono text-sm tracking-widest uppercase mb-2">02 — Valores</span>
<h3 className="title-newtab text-4xl">DNA Inegociável.</h3>
       ...
       <div className="md:col-span-2 md:row-span-1">
        <ZenithCard variant="teal" className="h-full p-10 flex flex-col justify-between group overflow-hidden relative transition-all hover:-translate-y-2 hover:shadow-xl">
         <div className="absolute top-0 right-0 p-10 opacity-10 group-hover:scale-110 transition-transform duration-700">
          <FontAwesomeIcon icon={faCode} className="text-9xl " />
         </div>
         <FontAwesomeIcon icon={faGlobe} className="text-3xl mb-4 w-8" />
         <div>
    ...
    <section id="transparencia" className="py-16 md:py-32 px-4 md:px-6 scroll-mt-32">
     <div className="max-w-5xl mx-auto space-y-8 md:space-y-12">
      <div className="text-center max-w-2xl mx-auto mb-8 md:mb-16">
       <span className=" font-mono text-sm tracking-widest uppercase mb-4 block">03 — Dashboard</span>
<h2 className="title-newtab text-2xl sm:text-3xl md:text-5xl mb-4 md:mb-6">Confiança se prova.</h2>
      ...
      <div className="grid md:grid-cols-2 gap-4 md:gap-8 mt-8 md:mt-12">
       ...
       <div className="rounded-2xl overflow-hidden bg-[#1e1e1e] border border-[#333] shadow-2xl font-mono text-xs md:text-sm">
        ...
        <div className="p-6 space-y-4 text-gray-300">
         <div>
          <span className="">➜</span> <span className="">~</span> <span className="text-yellow-300">git status</span>
         </div>
         <div className="text-gray-400">On branch main<br />Your branch is up to date with 'origin/main'.</div>

         <div>
          <span className="">➜</span> <span className="">~</span> <span className="text-yellow-300">cat SECURITY.md</span>
         </div>
         ...
         <div className="animate-pulse">
          <span className="">➜</span> <span className="">~</span> <span className="inline-block w-2 H-4 bg-gray-500 ml-1 align-middle"></span>
         </div>
        </div>
       </div>
...
<h3 className="title-newtab text-2xl mb-4">100% Auditável.</h3>
       ...
       <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-10 relative z-10">
        ...
        <div className="shrink-0 text-center md:text-left">
         ...
         <div className="flex justify-center md:justify-start gap-4 text-xl text-[var(--text-secondary)]">
          <a href={SOCIAL_LINKS.TWITTER} target="_blank" className="transition-colors"><FontAwesomeIcon icon={faTwitter} /></a>
          ...
          <a href="mailto:dogespartano@proton.me" className="transition-colors"><FontAwesomeIcon icon={faGlobe} /></a>
         </div>
        </div>
        ...
        <div className="flex-1 text-center md:text-left space-y-6">
         <div>
          <span className=" font-bold uppercase tracking-wider text-xs">Sobre o Criador</span>
<h3 className="title-newtab text-3xl md:text-4xl mt-2">dogespartano</h3>
          <p className="text-[var(--text-secondary)] text-sm font-mono mt-1">Anon Developer & Founder</p>
         </div>

         <div className="prose dark:prose-invert">
          <p>
           "Olá. Sou um desenvolvedor anônimo movido por duas forças: <strong className=" dark:">Fé</strong> e <strong className=" dark:">Indignação</strong>."
          </p>
          <p>
