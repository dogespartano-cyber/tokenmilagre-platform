      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-4 lg:py-8 relative z-10">
        <div className="space-y-16 pb-20">
          ...
          <section id="essencial" className="scroll-mt-24">
            <div className="mb-8">
<h2 className="title-newtab text-2xl">O Essencial Primeiro</h2>
            </div>
          ...
          <section id="para-quem" className="scroll-mt-24">
            <div className="mb-8">
<h2 className="title-newtab text-2xl">Para quem é?</h2>
            </div>
...
<h3 className="title-newtab text-lg">Para Você Se...</h3>
                </div>
...
<h3 className="title-newtab text-lg">Não é Para Você Se...</h3>
                </div>
                <ul className="space-y-4">
                  {[
          ...
          <section id="trilha" className="scroll-mt-24">
            <div className="mb-8">
<h2 className="title-newtab text-2xl">Sua Trilha de Iniciante</h2>
            </div>
          ...
          <section id="explore" className="scroll-mt-24">
            <div className="mb-8">
<h2 className="title-newtab text-2xl">Explore a Plataforma</h2>
            </div>
          ...
          <section id="faq" className="scroll-mt-24">
            <div className="mb-8">
<h2 className="title-newtab text-2xl">Perguntas Frequentes</h2>
            </div>
...
<h3 className="title-newtab text-lg mb-2">Quer saber mais sobre o projeto?</h3>
