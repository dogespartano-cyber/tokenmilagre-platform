            ...
            <div className="max-w-7xl mx-auto space-y-8">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
                        ...
                        <div className="flex gap-4">
                            ...
                            <div className="bg-[var(--bg-tertiary)]/50 p-4 rounded-2xl border border-[var(--border-light)] min-w-[140px] text-center">
                                ...
                                <div className="text-2xl font-black text-green-500 flex justify-center items-center gap-2">
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <section>
                            <h2 className="text-xl font-bold mb-4 px-2">Continuar Aprendendo</h2>
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <div className="glass-card p-4 rounded-xl border border-[var(--border-light)] hover:border-[var(--brand-primary)] transition-colors cursor-pointer group">
                                    ...
                                    <h3 className="font-bold text-lg mb-1 group-hover:text-[var(--brand-primary)] transition-colors">Como proteger sua carteira Phantom</h3>
                                ...
                                <div className="glass-card p-4 rounded-xl border border-[var(--border-light)] hover:border-[var(--brand-primary)] transition-colors cursor-pointer group">
                                    ...
                                    <h3 className="font-bold text-lg mb-1 group-hover:text-[var(--brand-primary)] transition-colors">O que é Impermanent Loss?</h3>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="glass-card rounded-2xl p-6 border border-[var(--border-light)]">
                            <h3 className="text-sm font-bold text-[var(--text-secondary)] uppercase tracking-wider mb-4">Menu Rápido</h3>
                        ...
                        <div className="glass-card rounded-2xl p-6 border border-[var(--border-light)] bg-gradient-to-br from-[var(--bg-card)] to-[var(--bg-tertiary)]">
                            <h3 className="text-sm font-bold text-[var(--text-secondary)] uppercase tracking-wider mb-4">Status da Comunidade</h3>
