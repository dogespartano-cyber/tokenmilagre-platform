  ...
  return (
    <section className="py-8">
      <div className="mb-8">
        ...
        >
          <h2 className="title-newtab text-2xl group-hover:text-[var(--brand-primary)] transition-colors">
            Gráfico de Preços
          </h2>
        </Link>
      </div>

      <ZenithCard variant="glass" hoverEffect={false} className="h-[500px] flex flex-col">
