  ...
  return (
    <div className="group relative p-6 rounded-2xl zenith-card overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-lg title-newtab" style={{ color: 'var(--text-primary)' }}>
      ...
      <Link
        ...
        className="inline-flex items-center gap-2 px-4 py-2 rounded-lg font-bold text-sm transition-all bg-white dark:bg-zinc-500/10 hover:bg-zinc-50 dark:hover:bg-zinc-500/20 border border-zinc-200 dark:border-zinc-500/20 hover:shadow-lg"
      >
