...
export const metadata = {
  title: 'Recuperação: Guia para Vítimas de Golpes | $MILAGRE',
  description: 'Perdeu dinheiro em golpes cripto? Este guia mostra como recomeçar com segurança, identificar fraudes e construir um futuro financeiro sustentável.',
};
...
<h1 className="title-newtab text-4xl md:text-7xl leading-tight tracking-tight">
          ...
          <p className="text-xl md:text-2xl text-[var(--text-secondary)] max-w-3xl mx-auto leading-relaxed font-light">
            ...
            <span className="font-bold dark:"> você não está louco.</span> Mentiram para você.
          </p>
        </section>
...
<h2 className="title-newtab text-2xl md:text-3xl mb-8 text-center">Seus Primeiros Passos Seguros</h2>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-[var(--text-secondary)] text-sm mt-1">
                  Acesse nossa <Link href="/educacao" className=" font-bold hover:underline">central de educação</Link> para entender como identificar golpes e proteger seu patrimônio.
                </p>
              </div>
            </div>
            <div className="flex gap-4 items-start">
        ...
        <section className="text-center space-y-8 pt-8 pb-12">
          <div className="w-20 h-20 bg-teal-500/10 rounded-full flex items-center justify-center mx-auto mb-6 animate-pulse-slow">
