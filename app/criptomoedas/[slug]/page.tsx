...
<h1 className="title-newtab text-3xl mb-4">
...
<h1 className="text-4xl title-newtab ">
           {crypto.name}
          </h1>
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="glass-card rounded-xl p-6 border border-[var(--border-article)] shadow-md">
       <div className="flex items-center gap-3 mb-2">
        ...
        />
<h3 className="title-newtab text-sm text-[var(--text-article-muted)]">
         Market Cap
        </h3>
       </div>
     ...
     <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="glass-card rounded-2xl p-6 border border-[var(--border-article)] shadow-md">
       <div className="flex items-center gap-3 mb-4">
        ...
        />
<h2 className="title-newtab text-xl">
         Fornecimento
        </h2>
       </div>
     ...
     <div className="flex flex-wrap gap-4">
      ...
      {crypto.whitepaper && (
       <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center gap-2 px-6 py-3 rounded-lg font-semibold transition-all hover:opacity-90 shadow-md glass-card border border-[var(--border-article)] hover:border-[var(--brand-primary)]"
       >
        ...
        {relatedNews.map((news) => (
         ...
         >
          ...
          <div className="flex items-center justify-between mb-4">
           ...
           <div className={`flex items-center gap-1.5 text-xs font-bold px-2 py-1 rounded-md ${news.sentiment === 'positive' ? ' bg-emerald-500/10' :
            news.sentiment === 'negative' ? ' bg-red-500/10' :
             ' bg-amber-500/10'
            }`}>
