                    ...
                    <div className="prose prose-lg max-w-none" style={{ color: '#e8e8e8' }}>
                      <ReactMarkdown
                        ...
                        components={{
                          ...
                          h1: ({ children }) => (
                            <h1 className="text-2xl font-bold mb-4 mt-6" style={{ color: '#e8e8e8' }}>
                              {children}
                            </h1>
                          ),
                          h2: ({ children }) => (
                            <h2 className="text-xl font-bold mb-3 mt-5" style={{ color: '#e8e8e8' }}>
                              {children}
                            </h2>
                          ),
                          h3: ({ children }) => (
                            <h3 className="text-lg font-bold mb-2 mt-4" style={{ color: '#e8e8e8' }}>
                              {children}
                            </h3>
                          ),
