...
<h2 className="title-newtab text-xl flex items-center gap-2">
       ...
       {error && (
        <div className="rounded-xl p-4 mb-6 border border-red-200 bg-red-50 dark:bg-red-900/20 dark:border-red-800 flex items-start gap-3">
         ...
         <div>
          <p className="font-semibold dark:">Erro</p>
          <p className="text-sm dark:">{error}</p>
          <button
         ...
         <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-white/10">
           {paginatedContent.map((item) => {
            ...
            let typeClasses = 'bg-blue-100 dark:bg-blue-900/30 dark:';

            if (itemIsResource) {
             typeIcon = faBox;
             typeLabel = 'Recurso';
             typeClasses = 'bg-indigo-100 dark:bg-indigo-900/30 dark:';
            } else if (item.type === 'educational') {
             typeIcon = faGraduationCap;
             typeLabel = 'Educacional';
             typeClasses = 'bg-amber-100 dark:bg-amber-900/30 dark:';
            }
              ...
              <td className="px-6 py-4">
               {itemIsResource ? (
                <span className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold ${isPublished
                 ? 'bg-emerald-100 dark:bg-emerald-900/30 dark:'
                 : 'bg-red-100 dark:bg-red-900/30 dark:'
                 }`}>
              ...
              <td className="px-6 py-4">
               <div className="flex items-center justify-end gap-2">
                ...
                <button
                 ...
                 className="p-2 rounded-lg transition-all hover:bg-blue-50 dark:hover:bg-blue-900/20 dark:"
                 title="Editar com IA"
                >
                ...
                <button
                 ...
                 className="p-2 rounded-lg transition-all hover:bg-red-50 dark:hover:bg-red-900/20 disabled:opacity-50 disabled:cursor-not-allowed"
                 title="Deletar"
                >
                 {deleting === item.slug ? (
