            ...
            <div className="rounded-3xl p-8 border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/5 backdrop-blur-xl shadow-xl mb-8 relative overflow-hidden">
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-8">
                  <h2 className="text-2xl title-newtab flex items-center gap-3">
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="relative z-10 flex flex-col gap-4">
                            ...
                            <div>
                              <span className={`block font-bold text-lg mb-1 ${isSelected ? ' dark:text-white' : 'text-gray-600 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white'}`}>
                                {config.label}
                              </span>
                  ...
                  <div className="mb-8">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className="text-xs text-gray-500">
                        Custo estimado: <span className=" font-mono">~${(quantity * 0.008 * 2).toFixed(3)} USD</span>
                      </span>
                    </div>
                ...
                <div className="mb-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="title-newtab mb-2 text-lg">
                        Busca Inteligente de Tópicos
                      </h3>
                      <p className="text-sm /70 dark:text-gray-400 mb-3 leading-relaxed">
                        A IA buscará tópicos <strong className=" dark:">relevantes e atuais</strong> em tempo real, verificando duplicados no banco de dados antes de gerar.
                      </p>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                        <div className="flex items-center gap-2 text-xs text-gray-500">
                          <FontAwesomeIcon icon={faCheckCircle} className="w-3 h-3 /70" />
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-lg text-sm font-medium hover:bg-teal-500/10 transition-all border border-teal-500/20 hover:border-teal-500/40"
                    >
                      ...
                      >
                        <div className="flex items-start gap-3 relative z-10">
                          ...
                          <div className="flex-1">
                            <p className={`font-medium text-sm leading-relaxed ${isSelected ? ' dark:text-white' : 'text-gray-600 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white'}`}>
                              {topic}
                            </p>
                          </div>
          ...
          {isGenerating && totalSteps > 0 && (
            <div className="rounded-2xl p-6 border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/5 backdrop-blur-xl shadow-xl mb-8 relative overflow-hidden">
              <div className="flex items-center justify-between mb-4 relative z-10">
                <h3 className="title-newtab text-lg flex items-center gap-2">
                  <FontAwesomeIcon icon={faSpinner} className="w-4 h-4 animate-spin dark:" />
                  Gerando Artigos...
                </h3>
                <span className="text-sm font-mono bg-teal-500/10 px-3 py-1 rounded-full border border-teal-500/20">
            ...
            <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                ...
                <div className="rounded-2xl p-5 border border-teal-500/20 bg-teal-500/5 backdrop-blur-md">
                  <p className="text-xs dark:/80 uppercase tracking-wider mb-1">Sucesso</p>
                  <p className="text-3xl font-bold dark:">{successCount}</p>
                </div>
                <div className="rounded-2xl p-5 border border-red-500/20 bg-red-500/5 backdrop-blur-md">
                  <p className="text-xs dark:/80 uppercase tracking-wider mb-1">Erros</p>
                  <p className="text-3xl font-bold dark:">{errorCount}</p>
                </div>
                <div className="rounded-2xl p-5 border border-teal-500/20 bg-teal-500/5 backdrop-blur-md">
                  <p className="text-xs dark:/80 uppercase tracking-wider mb-1">Selecionados</p>
                  <p className="text-3xl font-bold dark:">{selectedCount}</p>
                </div>
              </div>
                      ...
                      <div className="flex items-start gap-5 relative z-10">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-3">
                            <h3 className="title-newtab text-xl pr-4 leading-tight">
                              {article.title}
                            </h3>
                            ...
                            <div className="flex-shrink-0">
                              ...
                              {article.status === 'generating' && (
                                <span className="text-xs px-3 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 flex items-center gap-2">
                                  <FontAwesomeIcon icon={faSpinner} className="w-3 h-3 animate-spin" />
                                  Gerando...
                                </span>
                              )}
                              {article.status === 'success' && (
                                <span className="text-xs px-3 py-1.5 rounded-full bg-teal-500/10 border border-teal-500/20 flex items-center gap-2">
                                  <FontAwesomeIcon icon={faCheckCircle} className="w-3 h-3" />
                                  Pronto
                                </span>
                              )}
                              {article.status === 'error' && (
                                <span className="text-xs px-3 py-1.5 rounded-full bg-red-500/10 border border-red-500/20 flex items-center gap-2">
                          ...
                          {article.error && (
                            <div className="mt-4 p-4 rounded-xl border border-red-500/20 bg-red-500/5">
                              <div className="flex items-start gap-3">
                                ...
                                <p className="text-sm flex-1">{article.error}</p>
                              </div>
                            </div>
                          )}
                        </div>
