...
export default function ArticleTypeSelector({
  ...
  return (
    <div className="mt-4 pt-4 border-t border-gray-200 dark:border-white/10">
      <h3 className="title-newtab text-sm mb-3 ">
      ...
      {selectedType && (
        <div className="mt-3 p-3 rounded-lg text-sm border-l-4 bg-teal-500/10 border-teal-500 text-gray-700 dark:text-gray-200">
