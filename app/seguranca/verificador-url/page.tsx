    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--bg-primary)' }}>
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1
            className="text-4xl font-bold mb-4 font-[family-name:var(--font-poppins)]"
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          >
            ...
            <ul className="space-y-3" style={{ color: 'var(--text-secondary)' }}>
              <li className="flex items-start gap-2">
                <FontAwesomeIcon icon={faLock} className="w-4 h-4 text-green-500 mt-1" />
                <span>Verifique o domínio completo (letra por letra)</span>
              </li>
              <li className="flex items-start gap-2">
                <FontAwesomeIcon icon={faGlobe} className="w-4 h-4 text-green-500 mt-1" />
          ...
          >
            ...
            <ul className="space-y-3" style={{ color: 'var(--text-secondary)' }}>
              <li className="flex items-start gap-2">
                <FontAwesomeIcon icon={faTimesCircle} className="w-4 h-4 text-red-500 mt-1" />
