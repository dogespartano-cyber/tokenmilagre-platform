...
<h1 className="title-newtab text-4xl md:text-7xl bg-clip-text text-transparent bg-gradient-to-r from-[var(--text-primary)] via-teal-500 to-emerald-500 tracking-tight">
            Manifesto $MILAGRE
          </h1>
          <p className="text-xl md:text-2xl text-[var(--text-secondary)] max-w-3xl mx-auto leading-relaxed font-light">
            ...
            Este é o nosso compromisso com a <span className="font-bold dark:">transparência</span> e a prosperidade real.
          </p>
        </div>
        ...
        <div className="glass-card p-8 md:p-12 rounded-3xl border border-[var(--border-light)] bg-[var(--bg-elevated)]/50 backdrop-blur-xl space-y-8 shadow-sm relative overflow-hidden">
          ...
          <div className="space-y-4 relative z-10">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-emerald-500/10 rounded-xl dark:">
