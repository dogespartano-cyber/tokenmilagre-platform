...
<h1 className="title-newtab text-4xl mb-4 font-inter">Termos de Uso</h1>
...
<h2 className="title-newtab text-2xl flex items-center gap-3">
...
<h2 className="title-newtab text-2xl flex items-center gap-3 text-yellow-500 mb-4">
...
<h2 className="title-newtab text-2xl flex items-center gap-3">
        ...
        <section className="space-y-4">
<h2 className="title-newtab text-2xl">4. Propriedade Intelectual</h2>
          <p className="text-[var(--text-secondary)] leading-relaxed">
        ...
        <section className="space-y-4">
<h2 className="title-newtab text-2xl">5. Links para Terceiros</h2>
          <p className="text-[var(--text-secondary)] leading-relaxed">
        ...
        <section className="space-y-4">
<h2 className="title-newtab text-2xl">6. Alterações nos Termos</h2>
          <p className="text-[var(--text-secondary)] leading-relaxed">
