            ...
            <div className="flex justify-between items-start gap-4">
              ...
              <div className="mt-1">
                <FontAwesomeIcon
                  ...
                  className={`text-xl ${mission.completed ? '' : 'text-[var(--text-tertiary)]'}`}
                />
              </div>
              ...
              <div className="flex-1">
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className={`text-xs font-bold px-2 py-1 rounded-full flex items-center gap-1 ${mission.completed ? 'bg-green-500/10 ' : 'bg-yellow-500/10 text-yellow-500'
                    }`}>
              ...
              {mission.claimed && (
                <span className="text-xs font-bold flex items-center gap-1 px-3 py-2">
