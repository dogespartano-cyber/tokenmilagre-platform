 ...
 return (
  <div className="space-y-6">
   ...
   <div className="space-y-4">
    ...
    {/* Título */}
<h1 className="title-newtab text-4xl md:text-5xl leading-tight font-inter" style={{ color: 'var(--text-primary)' }}>
     {article.title}
    </h1>
   ...
   >
    <ReactMarkdown
     components={{
      h1: ({ children }) => (
<h1 className="title-newtab text-3xl mt-8 mb-4 font-inter" style={{ color: 'var(--text-primary)' }}>
        {children}
       </h1>
      ),
      h2: ({ children }) => {
       ...
       return (
<h2 id={id} className="title-newtab text-2xl mt-8 mb-4 font-inter scroll-mt-24" style={{ color: 'var(--text-primary)' }}>
         {children}
        </h2>
       );
      },
      h3: ({ children }) => {
       ...
       const id = createSlug(text);
       return (
<h3 id={id} className="title-newtab text-xl mt-6 mb-3 font-inter scroll-mt-24" style={{ color: 'var(--text-primary)' }}>
         {children}
        </h3>
       );
      },
...
<h3 className="title-newtab" style={{ color: 'var(--text-primary)' }}>
       Nota de Transparência
      </h3>
