                    ...
                    <ZenithCard variant={isPositive ? 'success' : 'danger'} className="h-full flex flex-col justify-center min-h-[180px]">
                        ...
                        <div className="flex items-center gap-3 mb-2">
                            <div className={`hidden lg:block p-2 rounded-xl transition-transform duration-300 group-hover:scale-110 ${isPositive
                                ? 'bg-green-50 dark:bg-green-500/10 dark:'
                                : 'bg-red-50 dark:bg-red-500/10 dark:'
                                }`}>
                                <FontAwesomeIcon icon={faChartLine} className="w-5 h-5" />
                            </div>
                            <h3 className={`font-bold text-sm lg:text-base ${isPositive ? ' dark:' : ' dark:'
                                }`}>Capitalização</h3>
                        </div>
                ...
                const frontVolume = (
                    <ZenithCard variant={isPositiveVolume ? 'success' : 'danger'} className="h-full flex flex-col justify-center min-h-[180px]">
                        ...
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h3 className={`font-bold text-sm lg:text-base ${isPositiveVolume ? ' dark:' : ' dark:'
                                }`}>Volume 24h</h3>
                        </div>
            ...
            case 'btcDom':
                const frontBtcDom = (
                    <ZenithCard variant="orange" className="h-full flex flex-col justify-center min-h-[180px]">
                        {/* Header */}
                        <div className="flex items-center gap-3 mb-2">
                            <div className="hidden lg:block p-2 bg-orange-50 dark:bg-orange-500/10 rounded-xl transition-transform duration-300 group-hover:scale-110">
                                <TokenBTC className="w-5 h-5" variant="branded" />
                            </div>
                            <h3 className="title-newtab text-sm lg:text-base">Dominância BTC</h3>
                        </div>
            ...
            case 'ethDom':
                const frontEthDom = (
                    <ZenithCard variant="indigo" className="h-full flex flex-col justify-center min-h-[180px]">
                        {/* Header */}
                        <div className="flex items-center gap-3 mb-2">
                            <div className="hidden lg:block p-2 bg-indigo-50 dark:bg-indigo-500/10 rounded-xl transition-transform duration-300 group-hover:scale-110">
                                <TokenETH className="w-5 h-5" variant="branded" />
                            </div>
                            <h3 className="title-newtab text-sm lg:text-base">Dominância ETH</h3>
                        </div>
