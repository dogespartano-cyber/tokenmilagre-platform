                  ...
                  <div className="max-w-7xl mx-auto px-6 py-12">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-8 mb-12">
                              ...
                              <div className="flex flex-col">
                                    <h3 className="title-newtab text-sm uppercase tracking-wider mb-4">Produto</h3>
                              ...
                              {/* Community Column */}
                              <div className="flex flex-col">
                                    <h3 className="title-newtab text-sm uppercase tracking-wider mb-4">Comunidade</h3>
                              ...
                              {/* Legal Column */}
                              <div className="flex flex-col">
                                    <h3 className="title-newtab text-sm uppercase tracking-wider mb-4">Legal</h3>
