...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:max-w-md z-50 animate-fade-in-up">
      <div className="glass-card !backdrop-blur-sm md:!backdrop-blur-2xl !bg-white/98 md:!bg-white/90 dark:!bg-gray-900/98 dark:md:!bg-gray-900/90 p-6 rounded-2xl shadow-xl md:shadow-2xl border border-[var(--brand-primary)]/20 relative overflow-hidden">
...
<h3 className="title-newtab mb-2 font-inter">
