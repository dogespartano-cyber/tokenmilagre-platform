    ...
    <div className="grid md:grid-cols-2 gap-6 p-2">
      ...
      <ZenithCard variant="danger" className="h-full">
        <div className="flex items-center gap-4 mb-4">
          <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-red-500/10 shrink-0">
            <XCircle className="w-6 h-6" />
          </div>
<h3 className="title-newtab text-lg leading-tight">
      ...
      <ZenithCard variant="success" className="h-full">
        <div className="flex items-center gap-4 mb-4">
          <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-teal-500/10 shrink-0">
