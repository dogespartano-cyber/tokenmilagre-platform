...
const categoryConfig = {
  donations: { label: 'Doações', color: 'bg-green-100 dark:bg-green-900/30 dark:' },
  microcredit: { label: 'Microcrédito', color: 'bg-blue-100 dark:bg-blue-900/30 dark:' },
  education: { label: 'Educação', color: 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400' },
  infrastructure: { label: 'Infraestrutura', color: 'bg-orange-100 dark:bg-orange-900/30 dark:' },
};
    ...
    <Link href={`/comunidade/projetos/${project.slug}`}>
      <div className="group relative rounded-xl border transition-all duration-300 overflow-hidden bg-[var(--bg-secondary)] border-[var(--border-light)] hover:border-purple-400 dark:hover:border-purple-500 hover:shadow-xl">
        ...
        <div className="p-6">
          ...
          {/* Título */}
<h3 className="title-newtab text-xl mb-2 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors line-clamp-2">
            {project.name}
          </h3>
