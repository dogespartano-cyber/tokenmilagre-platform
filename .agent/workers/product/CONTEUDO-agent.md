...
inherits: _DNA.md
collaborates: [DESIGN, CODIGO, CONHECIMENTO, VIRAL]
...
*Nota: Ao trabalhar com o Agent VIRAL, lembre-se: ele fornece a ISCA (hook), você fornece a VERDADE (quality).*
```
...
@references:
  ...
  - .agent/templates/  # Prompts externos
@seo-references:
