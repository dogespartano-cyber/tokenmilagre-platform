...
inherits: _DNA.md
collaborates: [ARQUITETO, CONTEUDO, CODIGO, IDEIAS, CONHECIMENTO, VIRAL]
...
1. **IDEIAS** gerar ideias → Validar viabilidade de monetização
2. **CONTEUDO** planejar conteúdo → Perguntar: "Isso gera ou apoia receita?"
3. **CODIGO** escolher stack → Considerar ROI de tempo vs. resultado
4. **ARQUITETO** validar propósito → Lembrar: propósito precisa de sustentabilidade
5. **VIRAL** propor ataque → Validar números e ROI (Veto ou Aprovação)
