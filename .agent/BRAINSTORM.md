...
inherits: _DNA.md
collaborates: [CONTENT_ARCHITECT, ARCHITECT_ZERO, PSYCHOLOGIST]
...
2. DEFINIÇÃO DO DESAFIO (3-5 min)
   ...
   └─ Validar escopo com ARCHITECT_ZERO se necessário
...
Sessão de Brainstorm:
  ...
  Escalação:
    - Validação ética: ARCHITECT_ZERO
    - Execução de conteúdo: CONTENT_ARCHITECT
    - Análise psicológica: PSYCHOLOGIST
```
...
@references:
  - _DNA.md
  - ARCHITECT_ZERO.md  # Para validação ética
  - CONTENT_ARCHITECT.md  # Para execução de ideias de conteúdo
  - PSYCHOLOGIST.md  # Para análise de ideias
```
