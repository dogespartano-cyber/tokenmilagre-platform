  ...
  return (
    <section className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {/* Prós */}
        <div>
          <h3 className="text-xl font-bold mb-6 flex items-center gap-2 font-[family-name:var(--font-poppins)] text-emerald-500">
        ...
        {/* Contras */}
        <div>
          <h3 className="text-xl font-bold mb-6 flex items-center gap-2 font-[family-name:var(--font-poppins)] text-amber-500">
