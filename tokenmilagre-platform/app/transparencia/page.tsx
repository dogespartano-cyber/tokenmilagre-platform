            ...
            <div className="max-w-5xl mx-auto relative z-10 space-y-16">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="glass-card p-8 rounded-3xl border border-[var(--border-light)] bg-[var(--bg-elevated)]/50">
                        ...
                        <div className="space-y-4">
                            <Link href="https://discord.gg/jPgZr7BVXY" target="_blank" className="flex items-center justify-between p-4 rounded-2xl bg-[var(--bg-tertiary)]/50 border border-[var(--border-light)] hover:bg-[#5865F2]/10 hover:border-[#5865F2]/30 transition-all group">
                            ...
                            <Link href="https://t.me/+Bop_TVFc_mg3Njlh" target="_blank" className="flex items-center justify-between p-4 rounded-2xl bg-[var(--bg-tertiary)]/50 border border-[var(--border-light)] hover:bg-[#229ED9]/10 hover:border-[#229ED9]/30 transition-all group">
                                <div className="flex items-center gap-3">
