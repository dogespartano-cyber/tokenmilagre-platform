    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-6 p-8">
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-2">Loading Screen Demo</h2>
  ...
  render: () => {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-6 p-8">
        {!isLoading && (
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-4">Loading Complete!</h2>
            <button
              onClick={restart}
...
export const CustomDuration = {
  render: () => {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-6 p-8">
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4">Custom Duration Example</h2>
