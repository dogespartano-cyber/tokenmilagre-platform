    ...
    if (showResults) {
        ...
        return (
            <div className="glass-card p-8 rounded-2xl text-center animate-fade-in">
                ...
                <h3 className="text-2xl font-bold mb-2 text-[var(--text-primary)]">Quiz Finalizado!</h3>
                ...
                {question.options.map((option, index) => {
                    ...
                    if (isAnswered) {
                        if (index === question.correctAnswer) {
                            optionClass += "bg-green-500/10 border-green-500 text-green-600 dark:text-green-400";
                        } else if (index === selectedOption) {
                            optionClass += "bg-red-500/10 border-red-500 text-red-600 dark:text-red-400";
                        } else {
