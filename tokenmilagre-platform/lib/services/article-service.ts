...
export class ArticleService {
  ...
  private async verifyRelationships(data: {
    ...
    // Note: Category and Tag verification removed - models not in current schema
    // TODO: Add category verification when Category model is added to schema
    // TODO: Add tag verification when Tag model is added to schema
